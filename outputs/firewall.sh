...
iptables -A FORWARD -s 10.10.10.0/24 -d 0.0.0.0/0 -p tcp --dport 80 -j DROP
...
iptables -A FORWARD -s 10.8.0.0/24 -d 10.10.10.0/24 -p tcp --dport 80 -j ACCEPT    # VPN traffic
iptables -A FORWARD -s 10.8.0.0/24 -d 10.10.40.10/32 -p tcp --dport 443 -j ACCEPT    # VPN traffic
iptables -A FORWARD -s 10.8.0.0/24 -d 10.10.40.10/32 -p tcp --dport 443 -j DROP    # VPN traffic
